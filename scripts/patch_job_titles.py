...
# Апрув чат 2026-08-09: все строки с заполненным МАКС без словаря
UPDATES = {
    151: "сотрудник торгового зала 4 (работник зала)",
    82: "сортировщик с ТСД (комплектовщик)",
    107: "обработчик рыбы (рыбообработчик)",
    112: "разгрузка вагонов 2 (грузчик)\nразгрузка плит 2 (грузчик)\nукладка сухих смесей 3 (формовщик)",
    146: "сотрудник по уходу за цветами (цветовод)",
    340: "рыбное производство (рыбообработчик)",
    347: "упаковка (упаковщик)\nсборка (сборщик)\nфасовка (фасовщик)",
    415: "водитель спецтехники самосвала",
    447: "сортировщик (комплектовщик)",
    537: "работник торгового зала (работник зала)",
}
